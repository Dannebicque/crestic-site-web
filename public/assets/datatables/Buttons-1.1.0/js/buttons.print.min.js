(function (d) {
	"function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (c) {
		...
		c || (c = window);
		if (!a || !a.fn.dataTable)a = require("datatables.net")(c, a).$;
		a.fn.dataTable.Buttons || require("datatables.net-buttons")(c, a);
		return d(a, c, c.document)
	} : d(jQuery, window, document)
})(function (d, c, a) {
	var h = d.fn.dataTable, f = a.createElement("a");
	h.ext.buttons.print = {
		...
		text: function (d) {
			...
			var g = c.open("", ""), a = e.title.replace("*",
				d("title").text());
			g.document.close();
			var k = "<title>" + a + "</title>";
